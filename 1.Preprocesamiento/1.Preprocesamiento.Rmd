...
Clinical_data_Spain = as.data.frame(read.xlsx("consultar_datos"))
...
Clinical_data_Italy = as.data.frame(read.xlsx("consultar_datos"))
...
Expr_data <- read.table("consultar_datos")
...
```{r}
# Cargamos los datos de expresión a partir de un archivo de texto descargado desde Google Drive: 
Expr_data_it <- read.table("consultar_datos", sep = "\t", header = T)
