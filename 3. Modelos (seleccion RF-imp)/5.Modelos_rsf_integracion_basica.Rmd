---
title: "Modelos con selección basada en importancia de variables con un modelo RSF e integración en dos etapas"
...
Cargamos los datos de los 5 escenarios, incluyendo solo aquellos con las variables seleccionadas mediante importancia de variables con un modelo RSF. 
...
# ESCENARIO 4: Both before treatment
training_both_bt <- readRDS("training_both_bt_rf_prev.rds")
test_both_bt <- readRDS("test_both_bt_rf_prev.rds")

# ESCENARIO 5: Both after treatment
training_both_at <- readRDS("training_both_at_rf_prev.rds")
test_both_at <- readRDS("test_both_at_rf_prev.rds")
```
...
saveRDS(
  ...
  file = "rsf_escenario2_rfb.rds"
)
```

```{r}
# Cargamos el modelo entrenado: 
model_data <- readRDS("rsf_escenario2_rfb.rds")
...
saveRDS(
  list(model = best_model, learner = best_learner, params = best_params),
  file = "rsf_escenario4_rfb.rds"
)
```

```{r}
# Cargamos el modelo entrenado:
model_data <- readRDS("rsf_escenario4_rfb.rds")
best_model   <- model_data$model
best_learner <- model_data$learner
best_params  <- model_data$params
...
saveRDS(
  list(model = best_model, learner = best_learner, params = best_params),
  file = "rsf_escenario5_rfb.rds"
)
```

```{r}
# Cargamos el modelo entrenado:
model_data <- readRDS("rsf_escenario5_rfb.rds")
best_model   <- model_data$model
best_learner <- model_data$learner
best_params  <- model_data$params
...
saveRDS(
  list(model = best_model, learner = best_learner, params = best_params),
  file = "svm_escenario2_rfb.rds"
)
```

```{r}
# Cargamos el modelo entrenado:
model_data <- readRDS("svm_escenario2_rfb.rds")
best_model   <- model_data$model
best_learner <- model_data$learner
best_params  <- model_data$params
...
saveRDS(
  list(model = best_model, learner = best_learner, params = best_params),
  file = "svm_escenario4_rfb.rds"
)
```

```{r}
# Cargamos el modelo entrenado:
model_data <- readRDS("svm_escenario4_rfb.rds")
best_model   <- model_data$model
best_learner <- model_data$learner
best_params  <- model_data$params
...
saveRDS(
  list(model = best_model, learner = best_learner, params = best_params),
  file = "svm_escenario5_rfb.rds"
)
```

```{r}
# Cargamos el modelo entrenado:
model_data <- readRDS("svm_escenario5_rfb.rds")
best_model   <- model_data$model
best_learner <- model_data$learner
best_params  <- model_data$params
...
```{r}
# Eliminamos todas las que presentan un p-valor menor a 0.01 excepto Event_PFS (vamos a volver a comprobar si incumple la hipótesis de PH): 
incumplen <- c("HCG4B", "CENPA", "RP1.122P22.2", "LOC400706", "CEBPD")
...
saveRDS(training_expresion, "training_expresion_rf.rds")
...
saveRDS(test_expresion, "test_expresion_rf.rds")
saveRDS(test_both_bt, "test_both_bt.rds")
saveRDS(test_both_at, "test_both_at.rds")
```

```{r}
# Modelo con Event_PFS para comprobar que verifica la hipótesis: 
model <- coxph(Surv(OverallSurvival_days,Death)~., data=training_both_at)
...
saveRDS(
  list(model = best_model, learner = best_learner, params = best_params),
  file = "coxboost_escenario2_rfb.rds"
)
```

```{r}
# Cargamos el modelo entrenado: 
model_data <- readRDS("coxboost_escenario2_rfb.rds")
best_model   <- model_data$model
best_learner <- model_data$learner
best_params  <- model_data$params
...
result_row <- data.frame(
  escenario     = "coxboost_escenario2_rfb",
  cindex_train  = results$cindex$train,
  cindex_test   = results$cindex$test,
  auc1_train    = results$auc_1yr$train,
  auc1_test     = results$auc_1yr$test,
...
saveRDS(
  list(model = best_model, learner = best_learner, params = best_params),
  file = "coxboost_escenario4_rfb.rds"
)
```

```{r}
# Cargamos el modelo entrenado: 
model_data <- readRDS("coxboost_escenario4_rfb.rds")
best_model   <- model_data$model
best_learner <- model_data$learner
best_params  <- model_data$params
...
result_row <- data.frame(
  escenario     = "coxboost_escenario4_rfb",
  cindex_train  = results$cindex$train,
  cindex_test   = results$cindex$test,
  auc1_train    = results$auc_1yr$train,
  auc1_test     = results$auc_1yr$test,
...
saveRDS(
  list(model = best_model, learner = best_learner, params = best_params),
  file = "coxboost_escenario5_rfb.rds"
)
```

```{r}
# Cargamos el modelo entrenado: 
model_data <- readRDS("coxboost_escenario5_rfb.rds")
best_model   <- model_data$model
best_learner <- model_data$learner
best_params  <- model_data$params
...
result_row <- data.frame(
  escenario     = "coxboost_escenario5_rfb",
  cindex_train  = results$cindex$train,
  cindex_test   = results$cindex$test,
  auc1_train    = results$auc_1yr$train,
  auc1_test     = results$auc_1yr$test,
...
saveRDS(
  list(model = best_model, learner = best_learner, params = best_params),
  file = "deepsurv_escenario2_rfb.rds"
)
```

```{r}
# Cargamos el modelo entrenado: 
model_data <- readRDS("deepsurv_escenario2_rfb.rds")
best_params  <- model_data$params
...
result_row <- data.frame(
  escenario     = "deepsurv_escenario2_rfb",
  cindex_train  = results$cindex$train,
  cindex_test   = results$cindex$test,
  auc1_train    = results$auc_1yr$train,
  auc1_test     = results$auc_1yr$test,
...
saveRDS(
  list(model = best_model, learner = best_learner, params = best_params),
  file = "deepsurv_escenario4_rfb.rds"
)
```

```{r}
# Cargamos el modelo entrenado: 
model_data <- readRDS("deepsurv_escenario4_rfb.rds")
best_params  <- model_data$params
...
result_row <- data.frame(
  escenario     = "deepsurv_escenario4_rfb",
  cindex_train  = results$cindex$train,
  cindex_test   = results$cindex$test,
  auc1_train    = results$auc_1yr$train,
  auc1_test     = results$auc_1yr$test,
...
saveRDS(
  list(model = best_model, learner = best_learner, params = best_params),
  file = "deepsurv_escenario5_rfb.rds"
)
```

```{r}
# Cargamos el modelo entrenado: 
model_data <- readRDS("deepsurv_escenario5_rfb.rds")
best_params  <- model_data$params
...
result_row <- data.frame(
  escenario     = "deepsurv_escenario5_rfb",
  cindex_train  = results$cindex$train,
  cindex_test   = results$cindex$test,
  auc1_train    = results$auc_1yr$train,
  auc1_test     = results$auc_1yr$test,
...
saveRDS(
  list(model = best_model, learner = best_learner, params = best_params),
  file = "cox_escenario2_rfb.rds"
)
```

```{r}
# Cargamos el modelo entrenado: 
model_data <- readRDS("cox_escenario2_rfb.rds")
best_learner <- model_data$learner
best_params <- model_data$params
...
saveRDS(
  list(model = best_model, learner = best_learner, params = best_params),
  file = "cox_escenario4_rfb.rds"
)
```

```{r}
# Cargamos el modelo entrenado: 
model_data <- readRDS("cox_escenario4_rfb.rds")
best_learner <- model_data$learner
best_params <- model_data$params
...
saveRDS(
  list(model = best_model, learner = best_learner, params = best_params),
  file = "cox_escenario5_rfb.rds"
)
```

```{r}
# Cargamos el modelo entrenado: 
model_data <- readRDS("cox_escenario5_rfb.rds")
best_learner <- model_data$learner
best_params <- model_data$params
...
```{r}
saveRDS(results_matrix, "resultados_rfb.rds")
```